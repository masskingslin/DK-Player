...
android {
    ...
    signingConfigs {
        getByName("debug") {
            // Uses the auto-generated debug keystore already present in every
            // Android build environment (fixed password "android" — no secrets needed).
        }
    }
...
dependencies {
    ...
    // DataStore (settings persistence / export-import / theme)
